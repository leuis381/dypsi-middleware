...
function detectAddress(text) {
  // ... tu lógica de detección de dirección ...
}
...
// Exportar funciones con nombre
export { detectAddress, normalizeAddress };

// Exportar objeto por defecto (opcional)
export default { detectAddress, normalizeAddress };
