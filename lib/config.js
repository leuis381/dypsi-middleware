...
export const CONFIG = {
  ...
  DELIVERY_TIME_ESTIMATE_MINS: parseInt(process.env.DELIVERY_TIME_ESTIMATE_MINS || '30'),
  ...
  AI_CONTEXT_MEMORY_SIZE: parseInt(process.env.AI_CONTEXT_MEMORY_SIZE || '10'),
  AI_VIP_THRESHOLD_ORDERS: parseInt(process.env.AI_VIP_THRESHOLD_ORDERS || '10'),
  ...
  // Cache
  CACHE_TTL_MS: parseInt(process.env.CACHE_TTL_MS || '300000'), // 5 min
  CACHE_MAX_SIZE: parseInt(process.env.CACHE_MAX_SIZE || '1000'),
  
  // Session
  SESSION_TTL_MS: parseInt(process.env.SESSION_TTL_MS || '86400000'), // 24h
