...
export default asyncHandler(async (req, res) => {
  ...
  if (!apiKey) {
    logger.warn('OPENAI_API_KEY_NOT_CONFIGURED - Chat feature disabled', { requestId });
    metrics.record('chat.api_key_missing', 1);
    return sendError(res, new AppError('OpenAI API key no configurada. Esta feature es opcional.', 501, 'FEATURE_DISABLED'), 501);
  }
